...
credentials = service_account.Credentials.from_service_account_file("main/key.json")
...
def synthesize_text(text, audio_path):
    ...
    client = client.from_service_account_json("main/key.json")
...
if __name__ == "__main__":
    audio_path = "../Wav2Lip/temp/audio.wav"
    text = ""
